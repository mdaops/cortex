module github.com/mdaops/cortex/configurations/management/functions/xtenant
...
require (
	...
	github.com/crossplane-contrib/provider-argocd v0.14.1 // indirect
	github.com/crossplane-contrib/provider-kubernetes v1.2.0 // indirect
